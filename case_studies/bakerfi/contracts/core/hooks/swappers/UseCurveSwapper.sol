...
abstract contract UseCurveSwapper is ISwapHandler {
    ...
    bytes32 internal constant _CURVE_ROUTER_SLOT = 0x12bf5c1f8c71d2ab50ad26cd63e0f5c50ba43161b985f5d4c823c1c5b55e3f1b;
...
contract UseCurveSwapperMock is UseCurveSwapper {
     ...
     */
    function test__swap(ISwapHandler.SwapParams memory params) external payable returns (uint256, uint256) {
        return swap(params);
    }
}
