...
abstract contract UseUniV2Swapper is ISwapHandler {
    ...
    bytes32 private constant _V2_UNI_ROUTER_SLOT = 0x47b2c96b5499f1e2d1a7c2ef4c1a5a1e0d4a0c2e4b6d8f0a2c4e6f8a0c2e4b6d;
...
contract UseUniV2SwapperMock is UseUniV2Swapper {
     ...
     */
    function test__swap(ISwapHandler.SwapParams memory params) external returns (uint256 amountIn, uint256 amountOut) {
        return swap(params);
    }
}
