...
contract UseIERC4626Mock is UseIERC4626 {
     ...
     * @param receiver The address to receive the shares.
     */
    function test__depositVault(IERC4626 vault, uint256 assets, address receiver) external returns (uint256) {
     ...
     * @param receiver The address to receive the shares.
     */
    function test__mintVault(IERC4626 vault, uint256 shares, address receiver) external returns (uint256) {
